    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            if (tag2 - tag1 > tag1 - tag2) {
                dif = tag2 - tag1;
            }if (tag1 - tag2 > tag2 - tag1){
                dif = tag1 -tag2;
            }if (tag3 - tag2 > tag2 - tag3) {
                dif = tag3 - tag2;
            }if (tag2 - tag3 > tag3 - tag2){
                dif = tag2 -tag3;
            }if (tag4 - tag3 > tag3 - tag4) {
                dif = tag4 - tag3;
            }if (tag3 - tag4 > tag4 - tag3) {
                dif = tag3 - tag4;
            }if (tag5 - tag4 > tag4 - tag5) {
                dif = tag5 - tag4;
            }if (tag4 - tag5 > tag5 - tag4) {
                dif = tag4 - tag5;
            }if (tag6 - tag5 > tag5 - tag6) {
                dif = tag6 - tag5;
            }if (tag5 - tag6 > tag6 - tag5) {
                dif = tag5 - tag6;
            }if (tag7 - tag6 > tag6 - tag7) {
                dif = tag7 - tag6;
            }if (tag6 - tag7 > tag7 - tag6) {
                dif = tag6 - tag7;
            }
