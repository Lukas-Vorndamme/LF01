...
public class Dreiecksungleichung {
    public static void main(String[] args) throws IOException {
        ...
        double h = (2/ kathete1) * Math.sqrt(s * (s-kathete1) * (s-kathete2) * (s-hypotenuse));
        double flaeche = hypotenuse * h /2;

        if (kathete1 + kathete2 < hypotenuse && kathete1 + hypotenuse < kathete2 && kathete2 + hypotenuse < kathete1) System.out.print("Das dreick funktioniert nicht");
        if (kathete1 + kathete2 >= hypotenuse && kathete1 + hypotenuse > kathete2 && kathete2 + hypotenuse > kathete1) System.out.print("Das dreick funktioniert \t " + flaeche);
